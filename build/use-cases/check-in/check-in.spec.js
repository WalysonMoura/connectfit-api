...
var CheckInUseCase = class {
  constructor(checkInsRepository2, gymsRepository2) {
    this.checkInsRepository = checkInsRepository2;
    this.gymsRepository = gymsRepository2;
  }
  async execute({
    gymId,
    userId,
...
var InMemoryGymsRepositories = class {
  ...
  async create({
    ...
    const gym = {
      id: id ?? (0, import_crypto2.randomUUID)(),
...
// src/use-cases/check-in/check-in.spec.ts
var gymsRepository;
var checkInsRepository;
var sut;
describe("", () => {
  beforeEach(async () => {
  ...
  it("", async () => {
    ...
    globalExpect(checkIn.id).toEqual(globalExpect.any(String));
  });
  it("", async () => {
