...
// src/use-cases/register/register.spec.ts
...
describe("Register Use Case", () => {
  ...
  it("", async () => {
    ...
    const isPasswordCorrectYHashed = await (0, import_bcryptjs2.compare)("12345", user.password_hash);
    globalExpect(isPasswordCorrectYHashed).toBeTruthy();
  });
  it("", async () => {
