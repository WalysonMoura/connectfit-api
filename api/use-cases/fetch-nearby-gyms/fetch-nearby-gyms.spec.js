...
// src/use-cases/fetch-nearby-gyms/fetch-nearby-gyms.spec.ts
var gymsRepository;
var sut;
describe("", () => {
  beforeEach(async () => {
  ...
  it("", async () => {
    ...
    globalExpect(gyms).toEqual([globalExpect.objectContaining({ title: "Near Gym" })]);
  });
});
